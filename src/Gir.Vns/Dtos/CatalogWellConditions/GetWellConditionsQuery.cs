...
public class GetWellConditionsQuery : BaseSortFilter<WellConditionDto, WellConditionSortPropertyName>
{
    ...
    /// </summary>
    protected override Dictionary<WellConditionSortPropertyName, Expression<Func<WellConditionDto, object>>> SupportedSortings =>
        new()
        {
            [WellConditionSortPropertyName.DateCreated] = x => x.DateCreated
        };
}
